...
<%
    ...
    if len(BookName) <= 0 then
        ...
        response.redirect("EditBookDetail.asp")
    end if
    ...
    QryStr = "UPDATE BooksDetail SET BookName = '" & BookName & "', CategoryId = " & CategoryId & ", AuthorId = " & AuthorId & ", PublisherId = " & PublisherId & ", LanguageId = " & LanguageId & ", BookPages = " & BookPages & ", Quantity = " & Quantity & ", CabinetId = " & CabinetId & ", ShelveId = " & ShelveId & " WHERE (BookId = " & BookId & ")"
